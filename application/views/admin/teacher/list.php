                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Öğretmenleri Listele</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 20%;">Uzmanlık Alanı</th>
                                            ...
                                            <?php if(!empty($teacher)) { ?>
                                                <?php foreach ($teacher as $key => $val) { ?>
                                                    <tr id="delete<?php echo $val->id; ?>">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" class="switch teacher-status"
                                                                   data-id="<?php echo $val->id; ?>"
                                                                   id="switch1" <?php echo $val->status == 1 ? "checked " :""; ?> />
                                                        </td>
                                                        <td>
                                                            <button onclick="window.location.href='<?php echo site_url('yonetim-paneli/ogretmen-duzenle/'.$val->id); ?>'" class="w-100 btn btn-warning buttonAnimation" data-animation="pulse"><i class="la la-refresh"></i></button>
                                                        </td>
                                                        <td>
                                                            <button class="w-100 btn btn-danger buttonAnimation delete-teacher"
                                                                    data-id="<?php echo $val->id; ?>"
